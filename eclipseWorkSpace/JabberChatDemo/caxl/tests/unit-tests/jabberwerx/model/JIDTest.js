...
jabberwerx.$(document).ready(function() {
  ...
  test("Test Escape Node", function() {
    ...
    same(jabberwerx.JID.escapeNode("\\5c"), "\\5c5c");
    same(jabberwerx.JID.escapeNode("<script>alert(\"'hi'\") </script>&:@\\"), "\\3cscript\\3ealert(\\22\\27hi\\27\\22)\\20\\3c\\2fscript\\3e\\26\\3a\\40\\");
  ...
  test("Test Unescape Node", function() {
    ...
    same(jabberwerx.JID.unescapeNode("\\5c"), "\\");
    same(jabberwerx.JID.unescapeNode("fo\\5co"), "fo\\o");
    same(jabberwerx.JID.unescapeNode("\\3cscript\\3ealert(\\22\\27hi\\27\\22)\\20\\3c\\2fscript\\3e\\26\\3a\\40\\5c"), "<script>alert(\"'hi'\") </script>&:@\\");
  });
