...
jabberwerx.$(document).ready(function() {
    ...
    test("Test applyConfig", function() {
        ...
        var subIQContent = 
            new jabberwerx.NodeBuilder('{http://jabber.org/protocol/muc#owner}query').node(sfrm.getDOM()).parent.data;        
        var cancelIQContent = new jabberwerx.NodeBuilder('{http://jabber.org/protocol/muc#owner}query').
            node(new jabberwerx.XDataForm("cancel").getDOM()).parent.data;
    ...
    var subIQContent = new jabberwerx.NodeBuilder('{http://jabber.org/protocol/muc#owner}query').
                        node(new jabberwerx.XDataForm("submit").getDOM()).parent.data;
    var cancelIQContent = new jabberwerx.NodeBuilder('{http://jabber.org/protocol/muc#owner}query').
                        node(new jabberwerx.XDataForm("cancel").getDOM()).parent.data;
